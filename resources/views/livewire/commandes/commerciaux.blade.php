    ...
    <div>
        ...
        <div class="mt-3 mb-3">
            <ul>
                ...
                <h5>Total des ventes par commercial :</h5>
                <table class="table">
                    <thead>
                        <tr>
                            <th>Commercial</th>
        ...
        <!-- AFFICHAGE DU RÉSULTAT ET DU CUMUL DES COMMISSIONS -->
        <div class="row mt-2 align-items-center">
            ...
            <div class="col-sm-6 text-sm-end">
                <span class="badge bg-success p-2 fs-6">
                    Total Commissions : {{ number_format($totalCommissionsGlobal ?? 0, 0, ',', ' ') }} <x-devise></x-devise>
                </span>
            </div>
        </div>
        ...
        <div wire:poll.2s class="table-responsive-sm mt-3">
            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ (method_exists($commande, 'montant') ? $commande->montant() : $commande->montant_total) - ($commande->coupon ?? 0) }} <x-devise></x-devise> </td>
        ...
        <script>
            function confirmStatusChange(event, commandeId) {
                ...
                Swal.fire({
                    ...
                    text: ` Voulez vous réellement changer le status à: ${newStatus}?`,
                    icon: 'warning',
