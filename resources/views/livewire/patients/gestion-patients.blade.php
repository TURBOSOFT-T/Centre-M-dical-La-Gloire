                        ...
                        @forelse($patients as $patient)
                            <tr>
                                ...
                                <td class="text-end px-4">
                                    ...
                                    <button onclick="confirm('Archiver ce dossier ?') || event.stopImmediatePropagation()" 
                                            wire:click="deletePatient({{ $patient->id }})" class="btn btn-sm btn-outline-danger" title="Archiver">
                ...
                <div class="modal-content radius-15 border-0" style="max-height: 90vh;">
                    ...
                    <form wire:submit.prevent="savePatient" class="d-flex flex-column" style="overflow: hidden;">
                        <div class="modal-body p-4" style="overflow-y: auto; max-height: calc(90vh - 130px);">
                            <div class="row g-3">
                                <!-- 1. ÉTAT CIVIL -->
                                <div class="col-12"><h6 class="text-primary font-weight-bold border-bottom pb-2"><i class="bx bx-user me-1"></i> État Civil</h6></div>
                                ...
                                <div class="col-12 mt-4"><h6 class="text-primary font-weight-bold border-bottom pb-2"><i class="bx bx-pulse me-1"></i> Constantes & Paramètres Vitaux</h6></div>
                                ...
                                <div class="col-12 mt-4"><h6 class="text-primary font-weight-bold border-bottom pb-2"><i class="bx bx-phone me-1"></i> Contacts & Localisation</h6></div>
                                ...
                                <!-- 5. ANTÉCÉDENTS -->
                                <div class="col-12 mt-4"><h6 class="text-primary font-weight-bold border-bottom pb-2"><i class="bx bx-health me-1"></i> Profil Médical & Antécédents</h6></div>
