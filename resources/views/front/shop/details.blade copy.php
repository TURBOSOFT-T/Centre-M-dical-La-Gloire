...
<head>
    ...
    <meta property="og:type" content="product" />
    <meta property="og:title" content="{{ $produit->nom }}" />
    <meta property="og:description" content="Prix : {{ number_format($produit->prix, 0, ',', ' ') }} FCFA" />
    <meta property="og:image" content="{{ url('storage/' . ltrim($produit->photo, '/')) }}" />
...
@if(!empty($whatsappUrl))
<li>
    <button type="button" class="btn-cart border-0 style-whatsapp" data-bs-toggle="modal" data-bs-target="#whatsappModal">
        <i class="ri-whatsapp-line fs-5"></i>
        <span>{{ \App\Helpers\TranslationHelper::TranslateText('Commander sur WhatsApp') }}</span>
    </button>
</li>
...
<div class="modal fade" id="whatsappModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('order.whatsapp') }}" method="POST" target="_blank">
                @csrf
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        ...
                        {{ \App\Helpers\TranslationHelper::TranslateText('Finaliser la commande sur WhatsApp') }}
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center p-2 mb-3 bg-light rounded border">
                        <img src="{{ asset('storage/' . ltrim($produit->photo, '/')) }}" 
                             alt="{{ $produit->nom }}" 
                             class="rounded me-3" 
                             style="width: 65px; height: 65px; object-fit: cover;">
                        <div>
                            <h6 class="mb-1 fw-bold text-dark">{{ $produit->nom }}</h6>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">{{ \App\Helpers\TranslationHelper::TranslateText('Nom complet :') }}</label>
                        <input type="text" name="name" class="form-control" placeholder="Ex: Thomas" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">{{ \App\Helpers\TranslationHelper::TranslateText('Quantité :') }}</label>
                        <input type="number" name="qty" class="form-control" value="1" min="1" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">{{ \App\Helpers\TranslationHelper::TranslateText('Ville de livraison :') }}</label>
                        <input type="text" name="city" class="form-control" placeholder="Ex: Douala, Akwa" required>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success w-100 fw-bold">
                        ...
                        {{ \App\Helpers\TranslationHelper::TranslateText('Envoyer la commande sur WhatsApp') }}
                    </button>
                </div>
            </form>
        </div>
